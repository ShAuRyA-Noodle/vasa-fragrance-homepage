...
import { createVelvetAtmosphere } from './velvet-atmosphere.js';

const page = document.querySelector('[data-rebel-in-velvet]');
...
if (page) {
  ...
  const scene = !reducedMotion.matches && host ? createVelvetAtmosphere(host, { stage }) : null;
