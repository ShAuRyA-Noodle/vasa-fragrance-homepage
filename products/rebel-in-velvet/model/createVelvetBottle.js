...
/**
 * Bounded front-view reconstruction of the original VASA Rebel in Velvet packshot.
 *
 ...
 */
export function createVelvetBottle({
  textureLoader = new THREE.TextureLoader(),
  plateUrl = '/plates/rebel-in-velvet.png',
} = {}) {
  const group = new THREE.Group();
  group.name = 'VASA Rebel in Velvet — photo-projected 3D bottle';
