...
import { createStrangerAtmosphere } from './stranger-atmosphere.js';

const page = document.querySelector('[data-sweetest-stranger]');
...
if (page) {
  ...
  const scene = !reducedMotion.matches && host ? createStrangerAtmosphere(host, { stage }) : null;
