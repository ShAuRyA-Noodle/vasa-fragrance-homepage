...
/**
 * Image-to-3D reconstruction of the supplied VASA Sweetest Stranger packshot.
 *
 ...
 */
export function createSweetestStrangerBottle({
  textureLoader = new THREE.TextureLoader(),
  plateUrl = '/plates/sweetest-stranger.png',
} = {}) {
  const group = new THREE.Group();
  group.name = 'VASA Sweetest Stranger — photo-projected 3D bottle';
