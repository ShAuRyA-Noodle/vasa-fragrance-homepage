...
/**
 * Image-to-3D reconstruction of the supplied VASA The Night Lingers packshot.
 *
 ...
 */
export function createNightBottle({
  textureLoader = new THREE.TextureLoader(),
  plateUrl = '/plates/the-night-lingers.png',
} = {}) {
  const group = new THREE.Group();
  group.name = 'VASA The Night Lingers — photo-projected 3D bottle';
  ...
  const glassFoot = addMesh('heavy clear glass foot',
    ...
    new THREE.MeshPhysicalMaterial({
      color: 0xfff4e6, roughness: 0.035, transmission: 0.94,
