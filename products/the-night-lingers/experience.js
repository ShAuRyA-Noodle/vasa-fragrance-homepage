...
import { createNightAtmosphere } from './storm-atmosphere.js';

const page = document.querySelector('[data-night-lingers]');
...
if (page) {
  ...
  const scene = !reducedMotion.matches && host ? createNightAtmosphere(host, { stage }) : null;
